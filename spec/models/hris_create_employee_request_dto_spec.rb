...
# Unit tests for StackOneHRIS::HrisCreateEmployeeRequestDto
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe StackOneHRIS::HrisCreateEmployeeRequestDto do
  let(:instance) { StackOneHRIS::HrisCreateEmployeeRequestDto.new }

  describe 'test an instance of HrisCreateEmployeeRequestDto' do
    it 'should create an instance of HrisCreateEmployeeRequestDto' do
      expect(instance).to be_instance_of(StackOneHRIS::HrisCreateEmployeeRequestDto)
    end
  end
